...
def load_waiting_approval_requests_from_db():
    query = """
    SELECT
        request_id,
        department,
    ...
    return pd.read_sql(
        text(query),
        engine,
        params={"status_pattern": "%Onayı Bekliyor"}
    )
...
if menu == "Talep Oluştur":
    ...
    with col1:
        ...
        requester_name = st.text_input("Talep Eden Kişi")
    ...
    if waiting_df.empty:
        ...
        approver_name = st.text_input("Onaylayan Kişi")
